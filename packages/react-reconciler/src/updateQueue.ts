...
export const processUpdateQueue1 = <State>(
	baseState: State,
	...
	const result: ReturnType<typeof processUpdateQueue1<State>> = {
...
export const processUpdateQueue = <State>(
	...
	memoizedState: State;
	baseState: State;
	baseQueue: Update<State> | null; // 合并后的结果
} => {
